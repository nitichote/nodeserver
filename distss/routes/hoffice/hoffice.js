...
router.get('/gsearch/:con/:dname', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const db = req.db2;
...
router.get('/school/show', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const db = req.db2;
...
router.get('/schoolenv/show', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const db = req.db2;
    let sql = `select * from schooldata s inner join ampall a on left(s.tamboncode,4) = a.code inner join hospitalcpho h on s.hcode = h.off_id left outer join school_env e on s.schoolid = e.schoolid and e.rpyear='2563' limit 1  `;
    try {
        const raw = yield db.raw(sql);
        res.send({ ok: true, message: raw[0] });
    }
...
router.get('/tbl/:tbl', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const db = req.db2;
...
router.get('/amp36', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const db = req.db2;
    const tbl = req.params.tbl;
...
//# sourceMappingURL=hoffice.js.map